              ...
              <div className="text-lg sm:text-xl flex justify-between items-center p-2 px-2 sm:px-2 ">
                ...
                <div>
                  <label
                    ...
                    className="inline-block cursor-pointer rounded-lg bg-transparent border-white border py-1 px-1 transition-all duration-200 ease-out text-center sm:px-2 md:px-3 text-white text-base hover:bg-white hover:text-blackd"
                  >
                    Upload File
                  </label>
                  <input
